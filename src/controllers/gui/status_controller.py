...
class StatusController(BaseController):
    ...
    def _on_started_response(self, event: Event):
        ...
        logger.debug(f"[DEBUG] StatusController: вызываем show_mita_thinking с {character_name}")
    ...
    def _on_successful_response(self, event: Event):
        ...
        logger.debug("[DEBUG] StatusController: вызываем hide_mita_status")
    ...
    def _on_failed_response_attempt(self, event: Event):
        ...
        logger.debug("[DEBUG] StatusController: вызываем show_mita_error_pulse")
    ...
    def _on_failed_response(self, event: Event):
        ...
        logger.debug(f"[DEBUG] StatusController: вызываем show_mita_error с {error_message}")
